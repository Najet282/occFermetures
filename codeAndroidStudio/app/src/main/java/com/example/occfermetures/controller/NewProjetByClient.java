...
import com.example.occfermetures.databinding.ActivityNewProjetByClientBinding;
...
public class NewProjetByClient extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    /*************************     ATTRIBUTS     ****************************/

    //composants graphiques
    private ActivityNewProjetByClientBinding binding;
    ...
    private int countClickOnPhoto = 0; // permettra d enregistrer la photo au bon endroit selon le nb de clic
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNewProjetByClientBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        //passage de param que l on recupere de ProjetsClientActivity
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                binding.spinnerCat.setOnItemSelectedListener(NewProjetByClient.this);
            }
        });
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            //paramIdClient que l on recupere de FicheClientActivityActivity
                            Projet createdProjet = WSUtils.createProjetClient(nomProjetSaisi, date, paramIdClient);
                            //on stocke l id du projet qui vient d etre cree
                            idProjetRecup = createdProjet.getIdProjet();
                            ...
                            Intent intent = new Intent(NewProjetByClient.this, NewProjetAjoute.class);
                            //passage de paramètre à envoyer dans NewProjetAjoute
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            //une fois le projet cree, ouverture de l activite FicheClientActivity
                            Intent intent = new Intent(NewProjetByClient.this, SousProjetActivity.class);
